(require '[clojure.math :refer (pow)]
         ...
         '[sfsim.render :refer (use-textures uniform-sampler)]
         '[sfsim.texture :refer (make-rgb-texture destroy-texture)]
...
(def shadertoy-source "#version 130
...
(def shadertoy-source (slurp "etc/navball.glsl"))
