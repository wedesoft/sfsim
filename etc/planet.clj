...
(go-loop []
         (if-let [tree (<! tree-state)]
                 (let [increase? (partial increase-level? tilesize radius polar-radius (Display/getWidth) 60 10 4 @position)]
...
(while (not (Display/isCloseRequested))
       ...
       (let [t1        (System/currentTimeMillis)
         ...
         (onscreen-render (Display/getWidth) (Display/getHeight)
                          ...
                          (uniform-int program-planet :height_size size)
                          (uniform-int program-planet :elevation_size size)
                          ...
                          (uniform-int program-atmosphere :height_size size)
                          (uniform-int program-atmosphere :elevation_size size)
