...
(def light2 (atom 0))
(def position (atom (matrix [0 (* -0 radius) (+ (* 1 polar-radius) 350000)])))
...
(while (not (Display/isCloseRequested))
       ...
       (let [t1        (System/currentTimeMillis)
         ...
         (onscreen-render (Display/getWidth) (Display/getHeight)
                          ...
                          (uniform-float program-planet :cloud_size 400000)
                          ...
                          (uniform-float program-atmosphere :cloud_size 400000)
