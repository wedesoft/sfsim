...
(uniform-float program-planet :cloud_size 10000)
...
(uniform-float program-planet :cloud_multiplier 0.002)
...
(uniform-float program-atmosphere :cloud_size 10000)
...
(uniform-float program-atmosphere :cloud_multiplier 0.002)
