...
(uniform-float program-planet :cloud_size 2000)
...
(uniform-float program-planet :cloud_multiplier 0.001)
...
(uniform-float program-atmosphere :cloud_size 2000)
...
(uniform-float program-atmosphere :cloud_multiplier 0.001)
