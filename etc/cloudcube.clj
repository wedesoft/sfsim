...
(while (not (Display/isCloseRequested))
       ...
       (let [light-direction (matrix [0 (cos @light) (sin @light)])
         ...
         (let [fbo (GL30/glGenFramebuffers)]
           ...
           (doseq [i (range 7)]
                  (GL30/glFramebufferTextureLayer GL30/GL_FRAMEBUFFER (+ GL30/GL_COLOR_ATTACHMENT0 i) (:texture opacity) 0 i))
           (GL30/glFramebufferTexture2D GL30/GL_FRAMEBUFFER GL30/GL_COLOR_ATTACHMENT7 GL11/GL_TEXTURE_2D (:texture opacity-shape) 0)
