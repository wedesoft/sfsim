...
(ray-scatter earth [rayleigh mie] 100 f (matrix [(+ radius 1000) 0 0]) (matrix [1 0 0]) (matrix [1 0 0]) true)
(ray-scatter earth [rayleigh mie] 100 f (matrix [(+ radius 1000) 0 0]) (matrix [0 1 0]) (matrix [1 0 0]) true)
        ...
        (let [r (sqrt (+ (* i i) (* j j)))]
          (if (> r n)
            ...
            (let [alpha (atan2 j i)
                  ...
                  z (sin beta)]
              (ray-scatter earth [rayleigh mie] 100 f (matrix [0 0 (+ radius 1000)]) (matrix [x y z]) (matrix [(cos a) 0 (sin a)]) true))))))
