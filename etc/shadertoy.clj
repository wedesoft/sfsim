...
(def shader-functions [rotation-x rotation-y rotation-z noise3d ray-box sdf-circle sdf-rectangle])
...
(def shader-functions-shaders (map #(make-shader % GL30/GL_FRAGMENT_SHADER) (flatten shader-functions)))
