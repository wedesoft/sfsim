...
(ns sfsim.model
  ...
  (:require
    ...
    [sfsim.plume :refer (cloud-plume-segment sample-plume-point setup-static-plume-uniforms model-data)]
    ...
    [sfsim.planet :refer (surface-radiance-function shadow-vars setup-dynamic-plume-uniforms
                          model-vars make-planet-geometry-renderer destroy-planet-geometry-renderer render-planet-geometry)]
