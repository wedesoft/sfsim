...
(def render-config
  #:sfsim.render{:amplification 6.0
                 :specular 1000.0
                 :fov (to-radians 60.0)
                 :min-z-near 1.0})
...
(def cloud-config
  #:sfsim.clouds{:cloud-octaves (octaves 4 0.7)
...
(def shadow-config
  #:sfsim.opacity{:num-opacity-layers 7
                  :shadow-size 1024
                  :num-steps 3
                  :opacity-biases [300.0 2000.0 4000.0]
