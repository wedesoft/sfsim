           ...
           (let [t1 (System/currentTimeMillis)
             ...
             (let [norm-pos   (mag @position)
                   ...
                   clouds     (texture-render-color-depth
                                ...
                                (uniform-matrix4 program-cloud-planet "inverse_transform" (inverse extrinsics))
                                ...
                                (uniform-matrix4 program-cloud-atmosphere "transform" extrinsics)
                                (uniform-matrix4 program-cloud-atmosphere "inverse_transform" (inverse extrinsics))
               ...
               (onscreen-render window
                                ...
                                (uniform-matrix4 program-planet "inverse_transform" (inverse extrinsics))
                                ...
                                (uniform-matrix4 program-atmosphere "transform" extrinsics)
                                (uniform-vector3 program-atmosphere "origin" @position)
                                (uniform-matrix4 program-atmosphere "inverse_transform" (inverse extrinsics))
