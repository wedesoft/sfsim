...
(def sphere (make-sphere 0.5 1000.0 (vec3 2 3 5) (q/->Quaternion 0 1 0 0)))
...
(facts "Get position vector, rotation matrix, and velocities of box body"
       (let [box (make-box (vec3 0.2 0.3 0.5) 1000.0 (vec3 2 3 5) (q/->Quaternion 0 1 0 0))]
...
(fact "Test restitution of sphere"
      (let [sphere1 (make-sphere 1.0 1000.0 (vec3 0.0  2.0 0.0) (q/->Quaternion 1 0 0 0))
            sphere2 (make-sphere 1.0 1000.0 (vec3 0.0 -2.0 0.0) (q/->Quaternion 1 0 0 0))]
...
(fact "Mesh prevents object from dropping"
      (let [mesh   (make-mesh #:sfsim.quadtree{:vertices [(vec3 -1 0 -1) (vec3 1 0 -1) (vec3 1 0 1) (vec3 -1 0 1)]
            ...
            sphere (make-sphere 1.0 1000.0 (vec3 0.0 0.0 0.0) (q/->Quaternion 1 0 0 0))]
