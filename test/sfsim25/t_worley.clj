(ns sfsim25.t-worley
    (:require [midje.sweet :refer :all]
              [clojure.core.matrix :refer (dimensionality dimension-count mget array matrix)]
...
(facts "Create 3D Worley noise"
       (with-redefs [worley/random-point-grid (fn [n size] (facts n => 1 size => 2) (array [[[[0.5 0.5 0.5]]]]))]
