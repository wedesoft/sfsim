...
(deftest component-test
  (testing "Get components of quaternion"
    (is (= 2.0 (:a (->Quaternion 2 3 5 7))))
    (is (= 3.0 (:b (->Quaternion 2 3 5 7))))
    (is (= 5.0 (:c (->Quaternion 2 3 5 7))))
    (is (= 7.0 (:d (->Quaternion 2 3 5 7))))))
...
(deftest exp-test
  (testing "Exponentiation of quaternions"
    (are [result component q] (< (Math/abs (c/- result (component (exp q)))) 1e-6)
      -1.0 :a (->Quaternion 0 0 pi 0)
       0.0 :c (->Quaternion 0 0 pi 0)
       0.0 :a (->Quaternion 0 0 (/ pi 2) 0)
       1.0 :c (->Quaternion 0 0 (/ pi 2) 0)
      -e   :a (->Quaternion 1 0 pi 0)
       e   :c (->Quaternion 1 0 (/ pi 2) 0)
       0.0 :d (->Quaternion 0 0 0 pi)
       1.0 :d (->Quaternion 0 0 0 (/ pi 2))
       0.8 :b (->Quaternion 0 (c/* 0.4 pi) (c/* 0.3 pi) 0)
       0.6 :c (->Quaternion 0 (c/* 0.4 pi) (c/* 0.3 pi) 0))))
...
(deftest rotation-test
  (testing "Represent rotation using quaternion"
    (are [result component angle axis] (< (Math/abs (c/- result (component (rotation angle axis)))) 1e-6)
       1.0  :a 0          (->Vector3 0 0 1)
      -1.0  :a (c/* 2 pi) (->Vector3 0 0 1)
       0.36 :b pi         (->Vector3 0.36 0.48 0.8)
       0.8  :d pi         (->Vector3 0.36 0.48 0.8)
       0.18 :b (/ pi 3)   (->Vector3 0.36 0.48 0.8))))
