...
(mi/collect! {:ns ['sfsim25.sphere]})
(mi/instrument! {:report (pretty/thrower)})

(facts "Determine height above surface for given point"
  (height #:sfsim25.sphere{:centre (vec3 0 0 0) :radius 10.0} (vec3 10 0 0)) => 0.0
  (height #:sfsim25.sphere{:centre (vec3 0 0 0) :radius 10.0} (vec3 13 0 0)) => 3.0
  (height #:sfsim25.sphere{:centre (vec3 2 0 0) :radius 10.0} (vec3 13 0 0)) => 1.0)

(facts "Check ray for intersection with sphere"
       (let [sphere #:sfsim25.sphere{:centre (vec3 0 0 3) :radius 1.0}]
...
(facts "Check ray pointing downwards"
       (let [sphere #:sfsim25.sphere{:centre (vec3 3 2 1) :radius 1.0}]
