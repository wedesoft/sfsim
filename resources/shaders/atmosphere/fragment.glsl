...
void main()
{
  ...
  if (atmosphere_intersection.y > 0) {
    ...
    vec2 transmittance_index = transmittance_forward(scaled_point, scaled_direction, true);
    vec4 ray_scatter_index = ray_scatter_forward(scaled_point, scaled_direction, scaled_light, true);
